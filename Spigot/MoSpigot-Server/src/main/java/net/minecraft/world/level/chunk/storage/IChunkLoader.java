            ...
            try {
                ...
                if (i < 1493) {
                    ...
                    if ((Boolean) nbttagcompound.getCompound("Level").flatMap((nbttagcompound1) -> {
                        return nbttagcompound1.getBoolean("hasLegacyStructureData");
                    }).orElse(false)) {
                ...
                boolean belowZeroGenerationInExistingChunks = (generatoraccess != null) ? ((WorldServer) generatoraccess).spigotConfig.belowZeroGenerationInExistingChunks : org.mospigot.config.MoSpigotConfig.belowZeroGenerationInExistingChunks;
