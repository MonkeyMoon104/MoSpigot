...
public final class ItemStack implements DataComponentHolder {
    ...
    public void hurtAndBreak(int i, EntityLiving entityliving, EnumHand enumhand) {
        this.hurtAndBreak(i, entityliving, EntityLiving.getSlotForHand(enumhand));
    }
    ...
    private void addAttributeTooltips(Consumer<IChatBaseComponent> consumer, TooltipDisplay tooltipdisplay, @Nullable EntityHuman entityhuman) {
        if (tooltipdisplay.shows(DataComponents.ATTRIBUTE_MODIFIERS)) {
            for (EquipmentSlotGroup equipmentslotgroup : EquipmentSlotGroup.values()) {
                ...
                this.forEachModifier(equipmentslotgroup, (holder, attributemodifier, itemattributemodifiers_b) -> {
                    if (itemattributemodifiers_b != ItemAttributeModifiers.b.hidden()) {
                        ...
                        itemattributemodifiers_b.apply(consumer, entityhuman, holder, attributemodifier);
                    }
                });
            }
    ...
    public void forEachModifier(EquipmentSlotGroup equipmentslotgroup, TriConsumer<Holder<AttributeBase>, AttributeModifier, ItemAttributeModifiers.b> triconsumer) {
        ...
        EnchantmentManager.forEachModifier(this, equipmentslotgroup, (holder, attributemodifier) -> {
            triconsumer.accept(holder, attributemodifier, ItemAttributeModifiers.b.attributeModifiers());
        });
    }
