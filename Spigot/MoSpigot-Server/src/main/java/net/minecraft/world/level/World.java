...
public abstract class World implements GeneratorAccess, UUIDLookup<Entity>, AutoCloseable {
    ...
    public final MoSpigotWorldConfig spigotConfig; // Spigot

    public final SpigotTimings.WorldTimingsHandler timings; // Spigot
    public static BlockPosition lastPhysicsProblem; // Spigot
    private org.mospigot.TickLimiter entityLimiter;
    private org.mospigot.TickLimiter tileLimiter;
    ...
    protected World(WorldDataMutable worlddatamutable, ResourceKey<World> resourcekey, IRegistryCustom iregistrycustom, Holder<DimensionManager> holder, boolean flag, boolean flag1, long i, int j, org.bukkit.generator.ChunkGenerator gen, org.bukkit.generator.BiomeProvider biomeProvider, org.bukkit.World.Environment env) {
        this.spigotConfig = new MoSpigotWorldConfig(((net.minecraft.world.level.storage.WorldDataServer) worlddatamutable).getLevelName()); // Spigot
        this.generator = gen;
        ...
        this.entityLimiter = new org.mospigot.TickLimiter(spigotConfig.entityMaxTickTime);
        this.tileLimiter = new org.mospigot.TickLimiter(spigotConfig.tileMaxTickTime);
    }
