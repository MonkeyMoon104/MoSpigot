...
public class MoSpigotWorldConfig
{
    ...
    public MoSpigotWorldConfig(String worldName)
    {
        this.worldName = worldName;
        this.config = MoSpigotConfig.config;
        init();
    }
    ...
    public void init()
    {
        ...
        MoSpigotConfig.readConfig( MoSpigotWorldConfig.class, this );
    }
