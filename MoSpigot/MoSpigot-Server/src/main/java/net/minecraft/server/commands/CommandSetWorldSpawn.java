...
public class CommandSetWorldSpawn {
    ...
    public static void register(CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) net.minecraft.commands.CommandDispatcher.literal("setworldspawn").requires(net.minecraft.commands.CommandDispatcher.hasPermission(2))).executes((commandcontext) -> {
