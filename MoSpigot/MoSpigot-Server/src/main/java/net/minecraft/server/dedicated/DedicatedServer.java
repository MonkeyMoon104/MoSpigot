...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    public boolean initServer() throws IOException {
        ...
        if (MoSpigotConfig.discordWebhookEnabled) {
            DiscordWebhook.send(MoSpigotConfig.discordWebhookUrl, "🟢 **Server avviato!**");
        }
        ...
        org.mospigot.config.MoSpigotConfig.init((java.io.File) options.valueOf("spigot-settings"));
        org.mospigot.config.MoSpigotConfig.registerCommands();
        // Spigot end
