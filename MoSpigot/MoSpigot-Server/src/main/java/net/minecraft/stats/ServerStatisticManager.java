...
public class ServerStatisticManager extends StatisticManager {
    ...
    public ServerStatisticManager(MinecraftServer minecraftserver, File file) {
        ...
        this.file = file;
        // Spigot start
        for ( Map.Entry<net.minecraft.resources.MinecraftKey, Integer> entry : org.mospigot.config.MoSpigotConfig.forcedStats.entrySet() )
        {
    ...
    public void save() {
        if ( org.mospigot.config.MoSpigotConfig.disableStatSaving ) return; // Spigot
        try {
