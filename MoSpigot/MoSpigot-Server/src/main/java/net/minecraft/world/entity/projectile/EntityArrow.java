...
public abstract class EntityArrow extends IProjectile {
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        ...
        valueoutput.storeNullable("inBlockState", IBlockData.CODEC, this.lastState);
        valueoutput.putByte("shake", (byte) this.shakeTime);
        valueoutput.putBoolean("inGround", this.isInGround());
        valueoutput.store("pickup", EntityArrow.PickupStatus.LEGACY_CODEC, this.pickup);
    ...
    protected void readAdditionalSaveData(ValueInput valueinput) {
        ...
        this.pickup = (EntityArrow.PickupStatus) valueinput.read("pickup", EntityArrow.PickupStatus.LEGACY_CODEC).orElse(EntityArrow.PickupStatus.DISALLOWED);
