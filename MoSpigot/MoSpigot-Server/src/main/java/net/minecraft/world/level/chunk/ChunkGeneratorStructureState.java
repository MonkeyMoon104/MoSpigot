...
public class ChunkGeneratorStructureState {
    ...
    public static ChunkGeneratorStructureState createForFlat(RandomState randomstate, long i, WorldChunkManager worldchunkmanager, Stream<Holder<StructureSet>> stream, MoSpigotWorldConfig conf) { // Spigot
    ...
    public static ChunkGeneratorStructureState createForNormal(RandomState randomstate, long i, WorldChunkManager worldchunkmanager, HolderLookup<StructureSet> holderlookup, MoSpigotWorldConfig conf) { // Spigot
    ...
    // Spigot start
    private static List<Holder<StructureSet>> injectSpigot(List<Holder<StructureSet>> list, MoSpigotWorldConfig conf) {
