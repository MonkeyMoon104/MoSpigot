...
public class GenericAttributes {
    ...
    public static final Holder<AttributeBase> ATTACK_DAMAGE = register("attack_damage", new AttributeRanged("attribute.name.attack_damage", 2.0D, 0.0D, org.mospigot.config.MoSpigotConfig.attackDamage));
    ...
    public static final Holder<AttributeBase> CAMERA_DISTANCE = register("camera_distance", (new AttributeRanged("attribute.name.camera_distance", 4.0D, 0.0D, 32.0D)).setSyncable(true));
    ...
    public static final Holder<AttributeBase> MAX_ABSORPTION = register("max_absorption", (new AttributeRanged("attribute.name.max_absorption", 0.0D, 0.0D, org.mospigot.config.MoSpigotConfig.maxAbsorption)).setSyncable(true));
    public static final Holder<AttributeBase> MAX_HEALTH = register("max_health", (new AttributeRanged("attribute.name.max_health", 20.0D, 1.0D, org.mospigot.config.MoSpigotConfig.maxHealth)).setSyncable(true));
    ...
    public static final Holder<AttributeBase> MOVEMENT_SPEED = register("movement_speed", (new AttributeRanged("attribute.name.movement_speed", 0.7D, 0.0D, org.mospigot.config.MoSpigotConfig.movementSpeed)).setSyncable(true));
    ...
    public static final Holder<AttributeBase> WAYPOINT_TRANSMIT_RANGE = register("waypoint_transmit_range", (new AttributeRanged("attribute.name.waypoint_transmit_range", 0.0D, 0.0D, 6.0E7D)).setSentiment(AttributeBase.a.NEUTRAL));
    public static final Holder<AttributeBase> WAYPOINT_RECEIVE_RANGE = register("waypoint_receive_range", (new AttributeRanged("attribute.name.waypoint_receive_range", 0.0D, 0.0D, 6.0E7D)).setSentiment(AttributeBase.a.NEUTRAL));
